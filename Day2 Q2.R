...
barplot(occupation_by_gender, main="Count of Occupation by Gender", xlab="Occupation", ylab="Count", col=c("orange", "pink"), legend=rownames(occupation_by_gender))
...
barplot(gender_by_education, beside=TRUE, main="Gender Counts by Education Level", xlab="Education Level", ylab="Count", col=c("blue", "pink"), legend=rownames(gender_by_education))
